...
import {useMGoalsStore} from "@/store/kmgoals.js"
import { useSelectedNameStore } from '@/store/goals.js';
import MMidTerm from "../../components/Tables/MMidTerm.vue"
import MLongTerm from "../../components/Tables/MLongTerm.vue"
...
const handleSubmit = () => {
  addGoal();
  console.log("Manager Goal added")
};
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              ...
              <button type="submit" class="btn btn-success" data-bs-dismiss="modal" @click="$router.push('/m/')">Submit Request</button>
            </div>

  ...
  <div class="menu">
    ...
    <nav class="navbar navbar-expand-md ">
      ...
      <ul class="navbar-nav">
        ...
        <li :class="{ 'nav-item': true, 'active': $route.path === '/it/skillassessment', 'active-indicator': $route.path === '/it/skillassessment' }">
          <router-link to="/it/skillassessment" class="nav-link">
            Skill Assessment
          </router-link>
        </li>
        <li :class="{ 'nav-item': true, 'active': $route.path === '/it/trainingschedule', 'active-indicator': $route.path === '/it/trainingschedule' }">
          <router-link to="/it/trainingschedule" class="nav-link">
            Training Schedule
          </router-link>
        </li>
        <li :class="{ 'nav-item': true, 'active': $route.path === '/it/alltrainingschedule', 'active-indicator': $route.path === '/it/alltrainingschedule' }">
          <router-link to="/it/alltrainingschedule" class="nav-link">
            All Training Schedule
          </router-link>
        </li>
        <li :class="{ 'nav-item': true, 'active': $route.path === '/it/taskdeliverables', 'active-indicator': $route.path === '/it/taskdeliverables' }">
          <router-link to="/it/taskdeliverables" class="nav-link">
            Task/Deliverables
          </router-link>
        </li>
        <li :class="{ 'nav-item': true, 'active': $route.path === '/it/mentorshipplan', 'active-indicator': $route.path === '/it/mentorshipplan' }">
          <router-link to="/it/mentorshipplan" class="nav-link">Mentorship Plan</router-link>
        </li>

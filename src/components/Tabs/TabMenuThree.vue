  ...
  <div class="menu">
    ...
    <nav class="navbar navbar-expand-md ">
      ...
      <ul class="navbar-nav">
        ...
        <li :class="{ 'nav-item': true, 'active': $route.path === '/m/skillassessment', 'active-indicator': $route.path === '/m/skillassessment' }">
          <router-link to="/m/skillassessment" class="nav-link">
            Skill Assessment
          </router-link>
        </li>
        <li :class="{ 'nav-item': true, 'active': $route.path === '/m/trainingschedule', 'active-indicator': $route.path === '/m/trainingschedule' }">
          <router-link to="/m/trainingschedule" class="nav-link">
            Training Schedule
          </router-link>
        </li>
        <li :class="{ 'nav-item': true, 'active': $route.path === '/m/alltrainingschedule', 'active-indicator': $route.path === '/m/alltrainingschedule' }">
          <router-link to="/m/alltrainingschedule" class="nav-link">
            All Training Schedule
          </router-link>
        </li>
        <li :class="{ 'nav-item': true, 'active': $route.path === '/m/taskdeliverables', 'active-indicator': $route.path === '/m/taskdeliverables' }">
          <router-link to="/m/taskdeliverables" class="nav-link">
            Task/Deliverables
          </router-link>
        </li>
        <li :class="{ 'nav-item': true, 'active': $route.path === '/m/mentorshipplan', 'active-indicator': $route.path === '/m/mentorshipplan' }">
          <router-link to="/m/mentorshipplan" class="nav-link">Mentorship Plan</router-link>
        </li>
        <li :class="{ 'nav-item': true, 'active': $route.path === '/m/speakingengagement', 'active-indicator': $route.path === '/m/speakingengagement' }">
          <router-link to="/m/speakingengagement" class="nav-link">Speaking Engagement</router-link>
        </li>
      </ul>

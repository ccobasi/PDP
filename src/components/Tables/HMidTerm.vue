<script setup>
    import { useHGoalsStore } from "@/store/kmgoals";
...
const store = useHGoalsStore();
var goals = store.hgoals;
const goals_ = ref([])
goals_.value = store.hgoals
...
const options = ref([
  ...
  { value: 'Area of Interest', text: 'Area of Interest' },
...
const selectedTerm = ref('Mid Term Goal');

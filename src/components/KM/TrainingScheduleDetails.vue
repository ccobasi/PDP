      ...
      <div class="learn">
        ...
        <div class="frame">
          <div class="one">
            ...
            <textarea name="Learning Outcome" id="" placeholder="Type here" cols="30" rows="10"></textarea>
          </div>
          <div class="one">
            <div class="title">
            ...
            <textarea name="Training Method" id="" placeholder="Type here" cols="30" rows="10"></textarea>
          </div>
        </div>
        <div class="frame">
          <div class="one">
          ...
          <div class="one">
            ...
            <textarea name="Skill Metrix Mapping" id="" placeholder="Type here" cols="30" rows="10"></textarea>
          </div>
        </div>
        <div class="frame">
          <div class="one">

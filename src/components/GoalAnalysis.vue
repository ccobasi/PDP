...
import PChart from '../components/Charts/PChart.vue'
</script> 
<template>
  <div class="container mt-2">
    ...
    <div class="d-flex justify-content-between align-center ">
      <div class=" chart-box-3 box-padded">
        ...
        <PChart chart-id="goalcategory" :doughnut="true" />
        <!-- <h4 class="box-title pt-5">Actually Vs Desired </h4> -->
      </div>

      <div class=" chart-box-3 box-padded">

        <PChart chart-id="filteredGoalcategory" :doughnut="true" />
        <div class="d-flex">
          <h4 class="box-title pt-5">Filtered </h4>
          <select class="form-select mt-5" aria-label="Default select example" v-on:change="onSelectChange(e)" v-model="plan">
            <option class="opt" selected>All</option>
            <option class="opt" value="Not Started">Not Started</option>
            <option class="opt" value="Started">Started</option>

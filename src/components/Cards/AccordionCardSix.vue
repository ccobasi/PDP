...
watch(() => props.item, (first, second) => {
    ...
    selectedFinancialYear.value = newTransct.financialYearId
    selectedMentor.value = newTransct.mentor
    selectedGoals.value = newTransct.goals
    selectedActionPlan.value = newTransct.actionPlans
    selectedTimeLine.value = newTransct.targetCompletionDate
...
const accordionItems = ref([
  { title: 'Month', content: selectedMonth },
  { title: 'Financial Year', content: selectedFinancialYear },
  { title: 'Mentor', content: selectedMentor },
  { title: 'Goals', content: selectedGoals },
  { title: 'Action Plan', content: selectedActionPlan },
  { title: 'Timeline', content: selectedTimeLine },
